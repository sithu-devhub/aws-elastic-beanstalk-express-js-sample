    ...
    stages {
        ...
        stage('Build Docker Image') {
            steps {
                ...
                sh '''
                docker build -t sithuj/assignment2_22466972:${BUILD_NUMBER} . 2>&1 | tee docker-build.log || { echo "Docker image build failed, check docker-build.log for details"; exit 1; }
                '''
